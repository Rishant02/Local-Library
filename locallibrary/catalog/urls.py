...
# Add URLConf to create, update, and delete genres
urlpatterns += [
...
# Add URLConf to create, update, and delete languages
urlpatterns += [
...
# Add URLConf to create, update, and delete book instances
urlpatterns += [
    path("bookinstance/", views.BookInstanceListView.as_view(), name="bookinstance"),
    path(
